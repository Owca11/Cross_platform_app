...
List<Feeling> sampleFeelings = [
  ...
  Feeling(name: 'Excited', icon: Icons.celebration, prompt: 'I feel excited', color: Colors.purple.shade300),
  Feeling(name: 'Tired', icon: Icons.bedtime, prompt: 'I feel tired', color: Colors.purple.shade300),
  Feeling(
    name: 'Frustrated',
  ...
  Feeling(name: 'Anxious', icon: Icons.warning, prompt: 'I feel anxious', color: Colors.purple.shade300),
  Feeling(name: 'Calm', icon: Icons.spa, prompt: 'I feel calm', color: Colors.purple.shade300),
  Feeling(
    name: 'Overwhelmed',
    icon: Icons.blur_on,
  ...
  Feeling(name: 'Lonely', icon: Icons.person_off, prompt: 'I feel lonely', color: Colors.purple.shade300),
  Feeling(name: 'Proud', icon: Icons.emoji_events, prompt: 'I feel proud', color: Colors.purple.shade300),
];

List<Need> sampleNeeds = [
  Need(name: 'Water', icon: Icons.local_drink, prompt: 'I need water', color: Colors.purple.shade300),
  Need(name: 'Food', icon: Icons.restaurant, prompt: 'I need food', color: Colors.purple.shade300),
  Need(name: 'Rest', icon: Icons.hotel, prompt: 'I need rest', color: Colors.purple.shade300),
  Need(name: 'Help', icon: Icons.help, prompt: 'I need help', color: Colors.purple.shade300),
  Need(name: 'Hug', icon: Icons.favorite, prompt: 'I need a hug', color: Colors.purple.shade300),
  Need(name: 'Quiet', icon: Icons.volume_off, prompt: 'I need quiet', color: Colors.purple.shade300),
  Need(name: 'Bathroom', icon: Icons.wc, prompt: 'I need to use the bathroom', color: Colors.purple.shade300),
  Need(
    name: 'Medicine',
  ...
  Need(name: 'Comfort', icon: Icons.chair, prompt: 'I need comfort', color: Colors.purple.shade300),
  Need(name: 'Attention', icon: Icons.visibility, prompt: 'I need attention', color: Colors.purple.shade300),
  Need(name: 'Space', icon: Icons.space_bar, prompt: 'I need space', color: Colors.purple.shade300),
  Need(name: 'Talk', icon: Icons.chat, prompt: 'I need to talk', color: Colors.purple.shade300),
];

List<Thought> sampleThoughts = [
  Thought(name: 'Confused', icon: Icons.help_outline, prompt: 'I am confused', color: Colors.purple.shade300),
  Thought(name: 'Worried', icon: Icons.warning, prompt: 'I am worried', color: Colors.purple.shade300),
  Thought(name: 'Thinking', icon: Icons.lightbulb, prompt: 'I am thinking', color: Colors.purple.shade300),
  Thought(name: 'Remember', icon: Icons.memory, prompt: 'I remember', color: Colors.purple.shade300),
  Thought(
    name: 'Idea',
  ...
  Thought(name: 'Forget', icon: Icons.cancel, prompt: 'I forget', color: Colors.purple.shade300),
  Thought(name: 'Understand', icon: Icons.check_circle, prompt: 'I understand', color: Colors.purple.shade300),
  Thought(name: 'Dream', icon: Icons.cloud, prompt: 'I had a dream', color: Colors.purple.shade300),
  Thought(name: 'Plan', icon: Icons.schedule, prompt: 'I have a plan', color: Colors.purple.shade300),
  Thought(name: 'Wonder', icon: Icons.star, prompt: 'I wonder', color: Colors.purple.shade300),
  Thought(name: 'Know', icon: Icons.info, prompt: 'I know', color: Colors.purple.shade300),
];
